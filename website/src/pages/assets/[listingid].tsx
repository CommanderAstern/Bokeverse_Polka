      ...
      <div className="flex max-w-[500px] flex-col justify-center gap-y-4 p-2">
        ...
        <div className={"flex flex-col rounded-lg border border-[#e8ebe5]"}>
          <div className={`flex items-center justify-start p-3`}>
            <Image src={`https://ethereum.org/static/6f05d59dc633140e4b547cb92f22e781/40129/eth-diamond-purple-white.jpg`} height={20} width={20} alt=""/>
          </div>
          <Image
        ...
        <div className={"flex flex-col rounded-lg border border-[#e8ebe5]"}>
          ...
          <div className={"flex flex-col gap-y-2 bg-slate-50 p-3"}>
            ...
            <div className={`flex items-center space-x-3`}>
              <Image src={`https://ethereum.org/static/6f05d59dc633140e4b547cb92f22e781/40129/eth-diamond-purple-white.jpg`} height={24} width={24} alt="" />
